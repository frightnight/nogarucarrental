...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6"><div class="card"><div class="card-body"><div class="avatar-md mb-3"><span class="avatar-title bg-primary-subtle text-primary rounded-3 fs-22"><i class="ti ti-id-badge-2"></i></span></div><h4>Drivers</h4><p class="text-muted">Manage licensed drivers and their rates.</p><a href="{{ route('business.drivers.index') }}" class="btn btn-primary">Manage Drivers</a></div></div></div>
