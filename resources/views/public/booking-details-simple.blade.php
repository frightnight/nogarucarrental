        ...
        <div class="col-lg-8"><div class="card"><div class="card-body">
            <form method="POST" action="{{ route('bookings.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6"><label class="form-label">Pickup Date</label><input class="form-control" type="date" name="pickup_date" value="{{ old('pickup_date', request('pickup_date')) }}" required></div>
                    <div class="col-md-6"><label class="form-label">Pickup Time</label><input class="form-control" type="time" name="pickup_time" value="{{ old('pickup_time', request('pickup_time')) }}" required></div>
