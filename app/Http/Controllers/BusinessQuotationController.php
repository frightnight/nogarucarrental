...
class BusinessQuotationController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('panels.quotations.index', compact('business', 'quotations', 'cars', 'drivers', 'savedLocations', 'editingQuotation'));
    }
    ...
    private function fillQuotation(Quotation $quotation, Business $business, array $validated): void
    {
        ...
        $quotation->fill([
            ...
            'total_amount' => $vehicleRate + $driverRate + $distanceRate,
        ]);
    }
